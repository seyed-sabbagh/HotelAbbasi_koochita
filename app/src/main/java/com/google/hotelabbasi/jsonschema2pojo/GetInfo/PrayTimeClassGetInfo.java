...
public class PrayTimeClassGetInfo {
    ...
    @SerializedName("momtaz")
    @Expose
    private Boolean momtaz;
    @SerializedName("seen")
    @Expose
    ...
    public void setVabastegi(String vabastegi) {
        this.vabastegi = vabastegi;
    }
    ...
    public Boolean getMomtaz() {
        return momtaz;
    }

    public void setMomtaz(Boolean momtaz) {
        this.momtaz = momtaz;
    }
